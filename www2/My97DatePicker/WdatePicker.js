...
(function() {
    ...
    function U(K, C) {
        //   WdatePicker = U; k为调用WdatePicker时的参数列表
        if (!$dp) return;
        B();
        var L = {};
    ...
    function I(G, _) {
        ...
        function E(K, J) {
            ...
            function C() {
                ...
                $.push("<script>var t;t=t||setInterval(function(){if(doc.ready){debugger;new My97DP();$cfg.onload();$c.autoSize();$cfg.setPos($dp);clearInterval(t);}},20);</script>");
                J.setPos = B;
                J.onload = Z;
                H.write("<html>");
                H.cfg = J;
